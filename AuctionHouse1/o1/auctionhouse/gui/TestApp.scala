...
import o1.util.assignments.{arg, withStudentSolution}
...
private[gui] class DynamicObject[StaticType](private val wrapped: StaticType) extends Dynamic {
...
private[gui] trait RequestArguments[T <: AnyRef] {
  this: DynamicClass[T] =>
