...
object Task2 extends App {
  ...
  def revealSecret(scrambledPixel: Color) = Color(scrambledPixel.red * 10, 0, 0)

  val scrambledPic = Pic("hidden1.png")
  val solvedPic = scrambledPic.transformColors(revealSecret)
  launchUnscramblerGUI(scrambledPic, solvedPic)
}

// The hidden photo was taken by Duane Wessels and published under CC (http://creativecommons.org/licenses/by-nc-sa/3.0/). This program is in the public domain.
